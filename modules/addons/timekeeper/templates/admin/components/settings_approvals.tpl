...
<div class="timekeeper-approvals-settings">
  ...
  <form method="post" data-tk class="tk-approvals-card-form">
    ...
    <div class="tk-approvals-card" data-scope="viewall">
      <div class="tk-role-head">
        <div class="tk-role-head-left">
          ...
          <span class="tk-role-sub">Grant visibility to all admins’ timesheets</span>
        </div>
    ...
    <!-- Group 2: Approve/Unapprove + Min Task Time -->
    <div class="tk-approvals-card" data-scope="approve">
      <div class="tk-role-head">
        <div class="tk-role-head-left">
          <h5 class="tk-role-title">Roles that can Approve / Unapprove</h5>
          <span class="tk-role-sub">Control who can approve or unapprove timesheets</span>
        </div>
        <div class="tk-role-head-right">
          <label class="tk-role-toggle-all">
    ...
    <div class="tk-approvals-card" data-scope="display">
      <div class="tk-role-head">
        <div class="tk-role-head-left">
          <h5 class="tk-role-title">Pagination</h5>
          <span class="tk-role-sub">Set items per page for Pending/Approved Timesheets</span>
        </div>
      </div>
