<div class="timekeeper-root pending-root">
  ...
  <div class="pt-detail">
    ...
    <div class="body">
      ...
      <!-- Add New Line (Timesheet table-card layout) -->
              ...
              <?php if ($isEditing): ?>
                ...
                <form method="post"
                  ...
                  <div class="cell cell-flags cell-flags--grid">
                    <div class="flag-item">
                      <label class="tk-flag-label">Ticket</label>
                      <input type="text" name="ticket_id" class="tk-row-input tk-ticket-input"
                             placeholder="Ticket #" value="<?= htmlspecialchars($entry->ticket_id) ?>">
                    </div>
      ...
      <?php endif; // end empty($editTimesheetEntries) ?>
...
</div><!-- /.timekeeper-root.pending-root -->
